...
if __name__ == '__main__':
    card_1 = Mastercarp('9988776655443322', date(3023, 12, 15), '143')
    PaymentProcessor(23.15, card_1).call()

    card_2 = AnchoVisa('0123456789101112', date(3022, 3, 1), '992')
    PaymentProcessor(250.00, card_2).call()

    # from cards import ClamericanExpress
    # card_3 = ClamericanExpress('2468135746803579', date(3024, 8, 13), '8264')
